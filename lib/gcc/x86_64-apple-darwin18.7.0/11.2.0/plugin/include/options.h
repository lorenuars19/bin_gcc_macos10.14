...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 640,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 802,                               /* -Z */
  OPT_Zall_load = 803,                       /* -Zall_load */
  OPT_Zallowable_client = 804,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 805,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 806,                   /* -Zbind_at_load */
  OPT_Zbundle = 807,                         /* -Zbundle */
  OPT_Zbundle_loader = 808,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 809,                     /* -Zdead_strip */
  OPT_Zdylib_file = 810,                     /* -Zdylib_file */
  OPT_Zdynamic = 811,                        /* -Zdynamic */
  OPT_Zdynamiclib = 812,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 813,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 814,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 815,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 816,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 817,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 818,                     /* -Zimage_base */
  OPT_Zinit = 819,                           /* -Zinit */
  OPT_Zinstall_name = 820,                   /* -Zinstall_name */
  OPT_Zmulti_module = 821,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 822,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 823,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 824,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 825,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 826,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 827,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 828,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 829,                  /* -Zsingle_module */
  OPT_Zumbrella = 830,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 831,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 832,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 833, */                  /* -all_load */
  /* OPT_allowable_client = 834, */          /* -allowable_client */
  OPT_ansi = 835,                            /* -ansi */
  OPT_arch = 836,                            /* -arch */
  /* OPT_arch_errors_fatal = 837, */         /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 838,         /* -asm_macosx_version_min= */
  OPT_aux_info = 839,                        /* -aux-info */
  /* OPT_aux_info_ = 840, */                 /* -aux-info= */
  /* OPT_bind_at_load = 841, */              /* -bind_at_load */
  /* OPT_bundle = 842, */                    /* -bundle */
  /* OPT_bundle_loader = 843, */             /* -bundle_loader */
  OPT_c = 844,                               /* -c */
  OPT_callgraph = 845,                       /* -callgraph */
  OPT_client_name = 846,                     /* -client_name */
  OPT_compatibility_version = 847,           /* -compatibility_version */
  OPT_coverage = 848,                        /* -coverage */
  OPT_cpp = 849,                             /* -cpp */
  OPT_cpp_ = 850,                            /* -cpp= */
  OPT_current_version = 851,                 /* -current_version */
  OPT_d = 852,                               /* -d */
  /* OPT_dead_strip = 853, */                /* -dead_strip */
  OPT_debuglib_ = 854,                       /* -debuglib= */
  OPT_defaultlib_ = 855,                     /* -defaultlib= */
  OPT_defined_only = 856,                    /* -defined-only */
  OPT_demangle = 857,                        /* -demangle */
  /* OPT_dependency_file = 858, */           /* -dependency-file */
  ...
  /* OPT_dylib_file = 869, */                /* -dylib_file */
  OPT_dylinker = 870,                        /* -dylinker */
  OPT_dylinker_install_name = 871,           /* -dylinker_install_name */
  /* OPT_dynamic = 872, */                   /* -dynamic */
  /* OPT_dynamiclib = 873, */                /* -dynamiclib */
  OPT_e = 874,                               /* -e */
  OPT_export_dynamic = 875,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 876, */     /* -exported_symbols_list */
  OPT_fPIC = 877,                            /* -fPIC */
  OPT_fPIE = 878,                            /* -fPIE */
  OPT_fRTS_ = 879,                           /* -fRTS= */
  ...
  OPT_fapple_kext = 919,                     /* -fapple-kext */
  /* OPT_fargument_alias = 920, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 921, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 922, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 923, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 924,            /* -fasan-shadow-offset= */
  OPT_fasm = 925,                            /* -fasm */
  OPT_fassert = 926,                         /* -fassert */
  OPT_fassociative_math = 927,               /* -fassociative-math */
  OPT_fassume_phsa = 928,                    /* -fassume-phsa */
  ...
  OPT_fbuilding_libphobos_tests = 946,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 947,                        /* -fbuiltin */
  OPT_fbuiltin_ = 948,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 949,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 950,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 951,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 952,                    /* -fcall-saved- */
  OPT_fcall_used_ = 953,                     /* -fcall-used- */
  OPT_fcaller_saves = 954,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 955,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 956,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 957,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 958, */            /* -fcf-protection */
  OPT_fcf_protection_ = 959,                 /* -fcf-protection= */
  OPT_fchar8_t = 960,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 961,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 962, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 963,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 964,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 965,                         /* -fcheck= */
  ...
  /* OPT_fhelp = 1189, */                    /* -fhelp */
  /* OPT_fhelp_ = 1190, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1191,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1192,                     /* -fhonor-std */
  OPT_fhosted = 1193,                        /* -fhosted */
  OPT_fhuge_objects = 1194,                  /* -fhuge-objects */
  OPT_fident = 1195,                         /* -fident */
  OPT_fif_conversion = 1196,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1197,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1198,        /* -fignore-unknown-pragmas */
  OPT_filelist = 1199,                       /* -filelist */
  OPT_fimplement_inlines = 1200,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1201,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1202,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1203,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1204,             /* -findirect-inlining */
  OPT_findirect_virtual_calls = 1205,        /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 1206,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1207,               /* -finit-character= */
  OPT_finit_derived = 1208,                  /* -finit-derived */
  OPT_finit_integer_ = 1209,                 /* -finit-integer= */
  OPT_finit_local_zero = 1210,               /* -finit-local-zero */
  OPT_finit_logical_ = 1211,                 /* -finit-logical= */
  OPT_finit_real_ = 1212,                    /* -finit-real= */
  OPT_finline = 1213,                        /* -finline */
  OPT_finline_arg_packing = 1214,            /* -finline-arg-packing */
  OPT_finline_atomics = 1215,                /* -finline-atomics */
  OPT_finline_functions = 1216,              /* -finline-functions */
  OPT_finline_functions_called_once = 1217,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1218, */           /* -finline-limit- */
  OPT_finline_limit_ = 1219,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1220,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1221,        /* -finline-small-functions */
  OPT_finput_charset_ = 1222,                /* -finput-charset= */
  OPT_finstrument_functions = 1223,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1224,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1225,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1226,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1227,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1228,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1229,                    /* -finvariants */
  OPT_fipa_bit_cp = 1230,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1231,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1232, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1233,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1234,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1235,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1236,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1237, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1238,                    /* -fipa-modref */
  OPT_fipa_profile = 1239,                   /* -fipa-profile */
  OPT_fipa_pta = 1240,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1241,                /* -fipa-pure-const */
  OPT_fipa_ra = 1242,                        /* -fipa-ra */
  OPT_fipa_reference = 1243,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1244,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1245,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1246,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1247, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1248,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1249,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1250,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1251,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1252,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1253,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1254,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1255,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1256,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1257,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1258,              /* -fivar-visibility= */
  OPT_fivopts = 1259,                        /* -fivopts */
  OPT_fjump_tables = 1260,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1261,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1262,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1263,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1264,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1265,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1266,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1267,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1268,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1269,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1270,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1271,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1272,            /* -flarge-source-files */
  /* OPT_flat_namespace = 1273, */           /* -flat_namespace */
  OPT_flax_vector_conversions = 1274,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1275,            /* -fleading-underscore */
  OPT_flifetime_dse = 1276,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1277,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1278,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1279,                /* -flinker-output= */
  /* OPT_flive_patching = 1280, */           /* -flive-patching */
  OPT_flive_patching_ = 1281,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1282,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1283,                   /* -flocal-ivars */
  /* OPT_floop_block = 1284, */              /* -floop-block */
  /* OPT_floop_flatten = 1285, */            /* -floop-flatten */
  OPT_floop_interchange = 1286,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1287,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1288, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1289,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1290, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1291,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1292,                     /* -flra-remat */
  OPT_flto = 1293,                           /* -flto */
  OPT_flto_compression_level_ = 1294,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1295, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1296,                /* -flto-partition= */
  OPT_flto_report = 1297,                    /* -flto-report */
  OPT_flto_report_wpa = 1298,                /* -flto-report-wpa */
  OPT_flto_ = 1299,                          /* -flto= */
  OPT_fltrans = 1300,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1301,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1302,             /* -fmacro-prefix-map= */
  OPT_fmain = 1303,                          /* -fmain */
  OPT_fmath_errno = 1304,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1305,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1306,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1307,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1308,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1309,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1310,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1311,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1312,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1313,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1314,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1315,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1316,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1317,                  /* -fmodule-file= */
  OPT_fmodule_header = 1318,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1319,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1320,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1321,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1322,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1323,                   /* -fmodule-only */
  OPT_fmodule_private = 1324,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1325,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1326,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1327,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1328,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1329,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1330,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1331,                 /* -fms-extensions */
  OPT_fmudflap = 1332,                       /* -fmudflap */
  OPT_fmudflapir = 1333,                     /* -fmudflapir */
  OPT_fmudflapth = 1334,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1335,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1336,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1337,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1338,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1339,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1340,                 /* -fnil-receivers */
  OPT_fno_modules = 1341,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1342,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1343,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1344,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1345,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1346,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1347,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1348,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1349,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1350,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1351,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1352,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1353,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1354,                  /* -foffload-abi= */
  OPT_foffload_ = 1355,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1356,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1357,                         /* -fonly= */
  OPT_fopenacc = 1358,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1359,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1360,                        /* -fopenmp */
  OPT_fopenmp_simd = 1361,                   /* -fopenmp-simd */
  OPT_foperator_names = 1362,                /* -foperator-names */
  OPT_fopt_info = 1363,                      /* -fopt-info */
  OPT_fopt_info_ = 1364,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1365, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1366,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1367,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1368, */          /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 1369, */     /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 1370, */     /* -force_flat_namespace */
  OPT_fpack_derived = 1371,                  /* -fpack-derived */
  OPT_fpack_struct = 1372,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1373,                  /* -fpack-struct= */
  OPT_fpad_source = 1374,                    /* -fpad-source */
  OPT_fpartial_inlining = 1375,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1376,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1377,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1378,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1379,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1380,                    /* -fpeel-loops */
  OPT_fpeephole = 1381,                      /* -fpeephole */
  OPT_fpeephole2 = 1382,                     /* -fpeephole2 */
  OPT_fpermissive = 1383,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1384,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1385,                           /* -fpic */
  OPT_fpie = 1386,                           /* -fpie */
  OPT_fplan9_extensions = 1387,              /* -fplan9-extensions */
  OPT_fplt = 1388,                           /* -fplt */
  OPT_fplugin_arg_ = 1389,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1390,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1391,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1392,                /* -fpostconditions */
  OPT_fpre_include_ = 1393,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1394,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1395,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1396,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1397,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1398,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1399,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1400,           /* -fprintf-return-value */
  OPT_fprofile = 1401,                       /* -fprofile */
  OPT_fprofile_abs_path = 1402,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1403,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1404,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1405,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1406,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1407,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1408,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1409,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1410,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1411,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1412,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1413,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1414,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1415,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1416,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1417,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1418,               /* -fprofile-update= */
  OPT_fprofile_use = 1419,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1420,                  /* -fprofile-use= */
  OPT_fprofile_values = 1421,                /* -fprofile-values */
  OPT_fprotect_parens = 1422,                /* -fprotect-parens */
  OPT_framework = 1423,                      /* -framework */
  OPT_frandom_seed = 1424,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1425,                  /* -frandom-seed= */
  OPT_frange_check = 1426,                   /* -frange-check */
  OPT_freal_4_real_10 = 1427,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1428,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1429,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1430,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1431,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1432,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1433,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1434,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1435,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1436,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1437,               /* -frecord-marker=8 */
  OPT_frecursive = 1438,                     /* -frecursive */
  OPT_free = 1439,                           /* -free */
  OPT_freg_struct_return = 1440,             /* -freg-struct-return */
  /* OPT_fregmove = 1441, */                 /* -fregmove */
  OPT_frelease = 1442,                       /* -frelease */
  OPT_frename_registers = 1443,              /* -frename-registers */
  OPT_freorder_blocks = 1444,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1445,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1446,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1447,             /* -freorder-functions */
  OPT_frepack_arrays = 1448,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1449,          /* -freplace-objc-classes */
  OPT_frepo = 1450,                          /* -frepo */
  OPT_freport_bug = 1451,                    /* -freport-bug */
  OPT_frequire_return_statement = 1452,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1453,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1454, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1455,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1456,                   /* -fresolution= */
  OPT_frounding_math = 1457,                 /* -frounding-math */
  OPT_frtti = 1458,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1459,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1460,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1461,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1462,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1463,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1464,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1465,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1466,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1467, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1468,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1469,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1470,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1471,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1472,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1473,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1474,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1475,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1476,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1477,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1478,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1479,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1480,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1481,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1482,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1483,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1484, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1485,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1486,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1487,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1488,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1489,               /* -fsection-anchors */
  /* OPT_fsee = 1490, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1491,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1492,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1493,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1494,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1495,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1496,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1497,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1498,                   /* -fshort-enums */
  OPT_fshort_wchar = 1499,                   /* -fshort-wchar */
  OPT_fshow_column = 1500,                   /* -fshow-column */
  OPT_fshrink_wrap = 1501,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1502,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1503,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1504,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1505,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1506,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1507,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1508,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1509,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1510,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1511,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1512,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1513,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1514,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1515,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1516,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1517,                      /* -fsquangle */
  OPT_fssa_backprop = 1518,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1519,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1520,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1521,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1522, */             /* -fstack-check */
  OPT_fstack_check_ = 1523,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1524,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1525,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1526,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1527,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1528,               /* -fstack-protector */
  OPT_fstack_protector_all = 1529,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1530,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1531,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1532,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1533,                   /* -fstack-usage */
  OPT_fstats = 1534,                         /* -fstats */
  OPT_fstdarg_opt = 1535,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1536,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1537, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1538,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1539,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1540,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1541,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1542,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1543, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1544,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1545,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1546,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1547,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1548,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1549, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1550,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1551, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1552,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1553, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1554,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1555,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1556,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1557,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1558,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1559,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1560,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1561,                   /* -ftime-report */
  OPT_ftime_report_details = 1562,           /* -ftime-report-details */
  OPT_ftls_model_ = 1563,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1564,              /* -ftoplevel-reorder */
  OPT_ftracer = 1565,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1566,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1567,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1568,                   /* -ftrampolines */
  OPT_ftransition_all = 1569,                /* -ftransition=all */
  OPT_ftransition_complex = 1570,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1571,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1572,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1573,              /* -ftransition=field */
  OPT_ftransition_nogc = 1574,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1575,                /* -ftransition=tls */
  OPT_ftrapping_math = 1576,                 /* -ftrapping-math */
  OPT_ftrapv = 1577,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1578,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1579,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1580,                      /* -ftree-ccp */
  OPT_ftree_ch = 1581,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1582, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1583,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1584,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1585, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1586,                   /* -ftree-cselim */
  OPT_ftree_dce = 1587,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1588,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1589,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1590,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1591,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1592, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1593,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1594,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1595, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1596,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1597,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1598, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1599,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1600,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1601,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1602,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1603,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1604,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1605,                      /* -ftree-pre */
  OPT_ftree_pta = 1606,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1607,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1608, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1609,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1610,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1611,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1612,                     /* -ftree-slsr */
  OPT_ftree_sra = 1613,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1614, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1615, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1616,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1617,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1618,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1619, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1620,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1621, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1622,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1623,         /* -funconstrained-commons */
  OPT_funderscoring = 1624,                  /* -funderscoring */
  OPT_funit_at_a_time = 1625,                /* -funit-at-a-time */
  OPT_funittest = 1626,                      /* -funittest */
  OPT_funroll_all_loops = 1627,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1628,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1629,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1630, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1631,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1632,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1633,                 /* -funsigned-char */
  OPT_funswitch_loops = 1634,                /* -funswitch-loops */
  OPT_funwind_tables = 1635,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1636,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1637,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1638,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1639,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1640,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1641,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1642,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1643,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1644,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1645,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1646,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1647, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1648,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1649,                   /* -fverbose-asm */
  /* OPT_fversion = 1650, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1651,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1652,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1653,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1654,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1655,                   /* -fvisibility= */
  OPT_fvpt = 1656,                           /* -fvpt */
  OPT_fvtable_gc = 1657,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1658,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1659,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1660,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1661,                     /* -fvtv-debug */
  OPT_fweak = 1662,                          /* -fweak */
  OPT_fweak_templates = 1663,                /* -fweak-templates */
  OPT_fweb = 1664,                           /* -fweb */
  /* OPT_fwhole_file = 1665, */              /* -fwhole-file */
  OPT_fwhole_program = 1666,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1667,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1668,             /* -fworking-directory */
  OPT_fwpa = 1669,                           /* -fwpa */
  OPT_fwpa_ = 1670,                          /* -fwpa= */
  OPT_fwrapv = 1671,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1672,                 /* -fwrapv-pointer */
  OPT_fxref = 1673,                          /* -fxref */
  /* OPT_fzee = 1674, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1675,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1676,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1677,                     /* -fzero-link */
  OPT_g = 1678,                              /* -g */
  OPT_gant = 1679,                           /* -gant */
  OPT_gas_loc_support = 1680,                /* -gas-loc-support */
  OPT_gas_locview_support = 1681,            /* -gas-locview-support */
  OPT_gcoff = 1682,                          /* -gcoff */
  OPT_gcoff1 = 1683,                         /* -gcoff1 */
  OPT_gcoff2 = 1684,                         /* -gcoff2 */
  OPT_gcoff3 = 1685,                         /* -gcoff3 */
  OPT_gcolumn_info = 1686,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1687,                 /* -gdescribe-dies */
  OPT_gdwarf = 1688,                         /* -gdwarf */
  OPT_gdwarf_ = 1689,                        /* -gdwarf- */
  OPT_gdwarf32 = 1690,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1691,                       /* -gdwarf64 */
  OPT_gen_decls = 1692,                      /* -gen-decls */
  OPT_gfull = 1693,                          /* -gfull */
  OPT_ggdb = 1694,                           /* -ggdb */
  OPT_ggnu_pubnames = 1695,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1696,                   /* -gimple-stats */
  OPT_ginline_points = 1697,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1698, /* -ginternal-reset-location-views */
  OPT_gnat = 1699,                           /* -gnat */
  OPT_gnatO = 1700,                          /* -gnatO */
  OPT_gno_ = 1701,                           /* -gno- */
  OPT_gno_pubnames = 1702,                   /* -gno-pubnames */
  OPT_gpubnames = 1703,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1704,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1705,                   /* -gsplit-dwarf */
  OPT_gstabs = 1706,                         /* -gstabs */
  OPT_gstabs_ = 1707,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1708,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1709,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1710,                        /* -gtoggle */
  OPT_gused = 1711,                          /* -gused */
  OPT_gvariable_location_views = 1712,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1713,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1714,                           /* -gvms */
  OPT_gxcoff = 1715,                         /* -gxcoff */
  OPT_gxcoff_ = 1716,                        /* -gxcoff+ */
  OPT_gz = 1717,                             /* -gz */
  OPT_gz_ = 1718,                            /* -gz= */
  OPT_h = 1719,                              /* -h */
  OPT_headerpad_max_install_names = 1720,    /* -headerpad_max_install_names */
  OPT_help = 1721,                           /* -help */
  OPT_idirafter = 1722,                      /* -idirafter */
  OPT_iframework = 1723,                     /* -iframework */
  OPT_imacros = 1724,                        /* -imacros */
  /* OPT_image_base = 1725, */               /* -image_base */
  OPT_imultiarch = 1726,                     /* -imultiarch */
  OPT_imultilib = 1727,                      /* -imultilib */
  OPT_include = 1728,                        /* -include */
  /* OPT_init = 1729, */                     /* -init */
  /* OPT_install_name = 1730, */             /* -install_name */
  OPT_iplugindir_ = 1731,                    /* -iplugindir= */
  OPT_iprefix = 1732,                        /* -iprefix */
  OPT_iquote = 1733,                         /* -iquote */
  OPT_isysroot = 1734,                       /* -isysroot */
  OPT_isystem = 1735,                        /* -isystem */
  OPT_iwithprefix = 1736,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1737,              /* -iwithprefixbefore */
  OPT_k8 = 1738,                             /* -k8 */
  OPT_keep_private_externs = 1739,           /* -keep_private_externs */
  OPT_l = 1740,                              /* -l */
  OPT_lang_asm = 1741,                       /* -lang-asm */
  OPT_list = 1742,                           /* -list */
  OPT_m128bit_long_double = 1743,            /* -m128bit-long-double */
  OPT_m16 = 1744,                            /* -m16 */
  OPT_m32 = 1745,                            /* -m32 */
  OPT_m3dnow = 1746,                         /* -m3dnow */
  OPT_m3dnowa = 1747,                        /* -m3dnowa */
  OPT_m64 = 1748,                            /* -m64 */
  OPT_m80387 = 1749,                         /* -m80387 */
  OPT_m8bit_idiv = 1750,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1751,             /* -m96bit-long-double */
  OPT_mabi_ = 1752,                          /* -mabi= */
  OPT_mabm = 1753,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1754,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1755,                 /* -maddress-mode= */
  OPT_madx = 1756,                           /* -madx */
  OPT_maes = 1757,                           /* -maes */
  OPT_malign_data_ = 1758,                   /* -malign-data= */
  OPT_malign_double = 1759,                  /* -malign-double */
  OPT_malign_functions_ = 1760,              /* -malign-functions= */
  OPT_malign_jumps_ = 1761,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1762,                  /* -malign-loops= */
  OPT_malign_stringops = 1763,               /* -malign-stringops */
  OPT_mamx_bf16 = 1764,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1765,                      /* -mamx-int8 */
  OPT_mamx_tile = 1766,                      /* -mamx-tile */
  OPT_march_ = 1767,                         /* -march= */
  OPT_masm_ = 1768,                          /* -masm= */
  OPT_matt_stubs = 1769,                     /* -matt-stubs */
  OPT_mavx = 1770,                           /* -mavx */
  OPT_mavx2 = 1771,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1772,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1773,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1774,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1775,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1776,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1777,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1778,                      /* -mavx512bw */
  OPT_mavx512cd = 1779,                      /* -mavx512cd */
  OPT_mavx512dq = 1780,                      /* -mavx512dq */
  OPT_mavx512er = 1781,                      /* -mavx512er */
  OPT_mavx512f = 1782,                       /* -mavx512f */
  OPT_mavx512ifma = 1783,                    /* -mavx512ifma */
  OPT_mavx512pf = 1784,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1785,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1786,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1787,                      /* -mavx512vl */
  OPT_mavx512vnni = 1788,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1789,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1790,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1791,                       /* -mavxvnni */
  OPT_mbmi = 1792,                           /* -mbmi */
  OPT_mbmi2 = 1793,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1794,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1795,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1796,                    /* -mcet-switch */
  OPT_mcld = 1797,                           /* -mcld */
  OPT_mcldemote = 1798,                      /* -mcldemote */
  OPT_mclflushopt = 1799,                    /* -mclflushopt */
  OPT_mclwb = 1800,                          /* -mclwb */
  OPT_mclzero = 1801,                        /* -mclzero */
  OPT_mcmodel_ = 1802,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1803,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1804, */                    /* -mcpu= */
  OPT_mcrc32 = 1805,                         /* -mcrc32 */
  OPT_mcx16 = 1806,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1807,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1808,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1809,                /* -mdynamic-no-pic */
  ...
  OPT_mfix_and_continue = 1816,              /* -mfix-and-continue */
  OPT_mfma = 1817,                           /* -mfma */
  OPT_mfma4 = 1818,                          /* -mfma4 */
  OPT_mforce_drap = 1819,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1820,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1821,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1822,                       /* -mfpmath= */
  OPT_mfsgsbase = 1823,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1824,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1825, */              /* -mfused-madd */
  OPT_mfxsr = 1826,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1827,             /* -mgeneral-regs-only */
  OPT_mgfni = 1828,                          /* -mgfni */
  OPT_mhard_float = 1829,                    /* -mhard-float */
  OPT_mhle = 1830,                           /* -mhle */
  ...
  OPT_mindirect_branch_register = 1835,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1836,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1837,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1838,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1839,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1840, */            /* -mintel-syntax */
  OPT_mkernel = 1841,                        /* -mkernel */
  OPT_mkl = 1842,                            /* -mkl */
  ...
  OPT_mmacosx_version_min_ = 1849,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 1850,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1851,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1852,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1853,                  /* -mmitigate-rop */
  OPT_mmmx = 1854,                           /* -mmmx */
  OPT_mmovbe = 1855,                         /* -mmovbe */
  OPT_mmovdir64b = 1856,                     /* -mmovdir64b */
  OPT_mmovdiri = 1857,                       /* -mmovdiri */
  OPT_mmpx = 1858,                           /* -mmpx */
  OPT_mms_bitfields = 1859,                  /* -mms-bitfields */
  OPT_mmwaitx = 1860,                        /* -mmwaitx */
  OPT_mneeded = 1861,                        /* -mneeded */
  OPT_mno_align_stringops = 1862,            /* -mno-align-stringops */
  OPT_mno_default = 1863,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1864,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1865,                  /* -mno-push-args */
  OPT_mno_red_zone = 1866,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1867,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1868,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1869,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1870,                 /* -mone-byte-bool */
  ...
  OPT_mrtd = 1895,                           /* -mrtd */
  OPT_mrtm = 1896,                           /* -mrtm */
  OPT_msahf = 1897,                          /* -msahf */
  OPT_mserialize = 1898,                     /* -mserialize */
  OPT_msgx = 1899,                           /* -msgx */
  OPT_msha = 1900,                           /* -msha */
  OPT_mshstk = 1901,                         /* -mshstk */
  OPT_mskip_rax_setup = 1902,                /* -mskip-rax-setup */
  OPT_msoft_float = 1903,                    /* -msoft-float */
  OPT_msse = 1904,                           /* -msse */
  OPT_msse2 = 1905,                          /* -msse2 */
  OPT_msse2avx = 1906,                       /* -msse2avx */
  OPT_msse3 = 1907,                          /* -msse3 */
  OPT_msse4 = 1908,                          /* -msse4 */
  OPT_msse4_1 = 1909,                        /* -msse4.1 */
  OPT_msse4_2 = 1910,                        /* -msse4.2 */
  OPT_msse4a = 1911,                         /* -msse4a */
  /* OPT_msse5 = 1912, */                    /* -msse5 */
  OPT_msseregparm = 1913,                    /* -msseregparm */
  OPT_mssse3 = 1914,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1915,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 1918, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1919,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1920,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1921,            /* -mstringop-strategy= */
  OPT_mstv = 1922,                           /* -mstv */
  OPT_msymbol_stubs = 1923,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 1924,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 1925, */          /* -mtarget-linker= */
  OPT_mtbm = 1926,                           /* -mtbm */
  OPT_mtls_dialect_ = 1927,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1928,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1929,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1930,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1931,                         /* -mtune= */
  OPT_muintr = 1932,                         /* -muintr */
  /* OPT_multi_module = 1933, */             /* -multi_module */
  /* OPT_multiply_defined = 1934, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1935, */  /* -multiply_defined_unused */
  ...
  /* OPT_no_dead_strip_inits_and_terms = 1955, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1956,                          /* -nocpp */
  OPT_nodefaultlibs = 1957,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1958,                /* -nofixprebinding */
  OPT_nolibc = 1959,                         /* -nolibc */
  OPT_nomultidefs = 1960,                    /* -nomultidefs */
  OPT_nophoboslib = 1961,                    /* -nophoboslib */
  OPT_noprebind = 1962,                      /* -noprebind */
  OPT_noseglinkedit = 1963,                  /* -noseglinkedit */
  OPT_nostartfiles = 1964,                   /* -nostartfiles */
  OPT_nostdinc = 1965,                       /* -nostdinc */
  OPT_nostdinc__ = 1966,                     /* -nostdinc++ */
  OPT_nostdlib = 1967,                       /* -nostdlib */
  OPT_o = 1968,                              /* -o */
  OPT_object = 1969,                         /* -object */
  OPT_objects = 1970,                        /* -objects */
  OPT_p = 1971,                              /* -p */
  OPT_pagezero_size = 1972,                  /* -pagezero_size */
  ...
  OPT_pie = 1977,                            /* -pie */
  OPT_pipe = 1978,                           /* -pipe */
  OPT_prebind = 1979,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1980,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1981,                        /* -preload */
  ...
  OPT_private_bundle = 1994,                 /* -private_bundle */
  OPT_pthread = 1995,                        /* -pthread */
  OPT_quiet = 1996,                          /* -quiet */
  OPT_r = 1997,                              /* -r */
  OPT_rdynamic = 1998,                       /* -rdynamic */
  OPT_read_only_relocs = 1999,               /* -read_only_relocs */
  OPT_remap = 2000,                          /* -remap */
  OPT_reverse_sort = 2001,                   /* -reverse-sort */
  OPT_s = 2002,                              /* -s */
  OPT_save_temps = 2003,                     /* -save-temps */
  OPT_save_temps_ = 2004,                    /* -save-temps= */
  OPT_sectalign = 2005,                      /* -sectalign */
  OPT_sectcreate = 2006,                     /* -sectcreate */
  OPT_sectobjectsymbols = 2007,              /* -sectobjectsymbols */
  OPT_sectorder = 2008,                      /* -sectorder */
  OPT_seg1addr = 2009,                       /* -seg1addr */
  /* OPT_seg_addr_table = 2010, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 2011, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 2012, */                  /* -segaddr */
  OPT_segcreate = 2013,                      /* -segcreate */
  OPT_seglinkedit = 2014,                    /* -seglinkedit */
  OPT_segprot = 2015,                        /* -segprot */
  /* OPT_segs_read_only_addr = 2016, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 2017, */     /* -segs_read_write_addr */
  OPT_shared = 2018,                         /* -shared */
  OPT_shared_libgcc = 2019,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2020,               /* -shared-libphobos */
  /* OPT_single_module = 2021, */            /* -single_module */
  ...
  OPT_sub_library = 2096,                    /* -sub_library */
  OPT_sub_umbrella = 2097,                   /* -sub_umbrella */
  OPT_symbol_ = 2098,                        /* -symbol= */
  OPT_symbolic = 2099,                       /* -symbolic */
  OPT_t = 2100,                              /* -t */
  OPT_time = 2101,                           /* -time */
  OPT_time_ = 2102,                          /* -time= */
  OPT_traditional = 2103,                    /* -traditional */
  OPT_traditional_cpp = 2104,                /* -traditional-cpp */
  OPT_tree_stats = 2105,                     /* -tree-stats */
  OPT_trigraphs = 2106,                      /* -trigraphs */
  OPT_twolevel_namespace = 2107,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2108,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2109,                     /* -type-stats */
  OPT_u = 2110,                              /* -u */
  /* OPT_umbrella = 2111, */                 /* -umbrella */
  OPT_undef = 2112,                          /* -undef */
  OPT_undefined = 2113,                      /* -undefined */
  /* OPT_unexported_symbols_list = 2114, */  /* -unexported_symbols_list */
  OPT_v = 2115,                              /* -v */
  OPT_version = 2116,                        /* -version */
  OPT_w = 2117,                              /* -w */
  /* OPT_weak_reference_mismatches = 2118, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 2119,                    /* -whatsloaded */
  OPT_whyload = 2120,                        /* -whyload */
